...
description: Design and refactor Kotlin Multiplatform modules and their Kotlin-to-Swift boundary with clear source-set ownership, platform seams, exported APIs, integration packaging, and shared domain logic. Use when Claude Code works on KMP extraction, Android/iOS sharing, Swift interop, or framework integration. Use compose-screen-builder for shared Compose UI details.
---
