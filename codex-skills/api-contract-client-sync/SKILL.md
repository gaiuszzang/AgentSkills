...
description: Define, evolve, and synchronize API contracts, DTO mappings, and error models across Node.js backends, Android, KMP, native iOS, and web clients. Use when Codex changes request or response shapes, aligns producer and consumer models, plans backward-compatible evolution, or prevents contract drift.
---
