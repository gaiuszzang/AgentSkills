...
description: Build and refactor native iOS features in Swift and SwiftUI with explicit state ownership, structured concurrency, navigation, dependency seams, accessibility, and tests. Use when Codex works on SwiftUI screens, observable models, UIKit handoff, Apple platform services, or an iOS consumer of a KMP module. Do not use for UI implemented primarily in Compose Multiplatform.
---
