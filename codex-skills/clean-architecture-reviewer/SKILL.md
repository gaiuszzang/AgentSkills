...
description: Review codebases for dependency direction, module boundaries, ports and adapters, and test seams across Kotlin, Android, KMP/CMP, native iOS, Node.js backend, and web frontend code. Use when Codex is asked for an architecture review, layer-leak findings, refactor direction, or a judgment about clean boundaries.
---
