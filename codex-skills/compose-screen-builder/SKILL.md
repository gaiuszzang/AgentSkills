...
description: Build and refactor Jetpack Compose or Compose Multiplatform screens with unidirectional state, platform-aware UI boundaries, side-effect discipline, navigation, accessibility, and tests. Use when Codex edits shared or platform-specific Compose UI for Android, iOS, desktop, or web. Do not use for a purely native SwiftUI screen.
---
