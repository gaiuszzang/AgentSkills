...
description: Plan, implement, and refactor Kotlin or Android features with clean architecture boundaries, use cases, repository ports, ViewModel state, dependency injection, and tests. Use when Codex works on Android app features, JVM Kotlin modules, presentation-domain-data separation, or layered refactors where dependency direction matters.
---
