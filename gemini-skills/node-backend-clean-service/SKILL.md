...
description: Build and refactor Node.js backend services around clean architecture, use-case oriented modules, DTO validation, repository ports, adapters, transactions, and tests. Use when Gemini CLI edits APIs, workers, service modules, database flows, or backend refactors in Express, Fastify, Nest, or custom Node.js applications where layer boundaries should stay explicit.
---
